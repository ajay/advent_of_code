...
size_t part2() {
  ...
  //     {0, {"top", "bottom", "left_top", "left_bottom", "right_top",
  //     "right_bottom"}}, {1, {"right_top", "right_bottom"}}, {2, {"top",
  //     "middle", "bottom", "left_bottom", "right_top"}}, {3, {"top", "middle",
  //     "bottom", "right_top", "right_bottom"}}, {4, {"left_top", "middle",
  //     "right_top", "right_bottom"}}, {5, {"top", "middle", "bottom",
  //     "left_top", "right_bottom"}}, {6, {"top", "middle", "bottom",
  //     "left_top", "left_bottom", "right_bottom"}}, {7, {"top", "right_top",
  //     "right_bottom"}}, {8, {"top", "middle", "bottom", "left_top",
  //     "left_bottom", "right_top", "right_bottom"}}, {9, {"top", "middle",
  //     "bottom", "left_top", "right_top", "right_bottom"}},
  // };
  ...
  //                     const auto newEnd =
  //                     std::remove_if(possibleChars.begin(),
  //                     possibleChars.end(), [&chars](const auto& c){
  //                         return std::count(chars.begin(), chars.end(), c) ==
  //                         0;
  //                     });
  ...
  //                         // std::cout << index << ' ' << std::setw(20) <<
  //                         seg << " remainingChars: " << remainingChars <<
  //                         '\n'; const auto newEnd =
  //                         std::remove_if(remainingChars.begin(),
  //                         remainingChars.end(), [&chars](const auto& c){
  //                             return std::count(chars.begin(), chars.end(),
  //                             c) == 0;
  //                         });
